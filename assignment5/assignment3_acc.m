...
%Input voltage - Kalman Predictor acceleration - Kalman Predictor s.s. acceleration
...
legend('Input voltage','Estimated acceleration (predictor)', 'Estimated acceleration (predictor at s.s.)');



%% Show the Input voltage against the estimated ones
%Input voltage - Kalman Filter acceleration
figure; plot(time, M_volt); hold on; plot(time, filter3_acc); 
...
%Input voltage - Kalman Predictor acceleration
figure; plot(time, M_volt); hold on; plot(time, predictor3_acc); 
xlabel('Time [s]'); ylabel('Accelerations [rad/s^2]'); title("Kalman Predictor acceleration estimation");
legend('Input voltage', 'Estimated acceleration');

%Input voltage - Kalman Filter acceleration - Kalman Filter acceleration
figure; plot(time, M_volt); hold on; plot(time, filter3_acc); hold on; plot(time, predictor3_acc); 
xlabel('Time [s]'); ylabel('Accelerations [rad/s^2]'); title("Kalman Filter acceleration estimation");
legend('Input voltage', 'Estimated acceleration (filter)', 'Estimated acceleration (predictor)');

%Input voltage - Kalman Filter acceleration - Kalman Filter s.s. acceleration
figure; plot(time, M_volt); hold on; plot(time, filter3_acc); hold on; plot(time, filter3SS_acc);
xlabel('Time [s]'); ylabel('Accelerations [rad/s^2]'); title("Kalman Filter acceleration estimation at Steady-State");
legend('Input voltage','Estimated acceleration (filter)', 'Estimated acceleration (filter at s.s.)');

%Input voltage - Kalman Predictor acceleration - Kalman Predictor s.s. acceleration
figure; plot(time, M_volt); hold on; plot(time, predictor3_acc); hold on; plot(time, predictor3SS_acc);
...
legend('Input voltage','Estimated acceleration (filter)', 'Estimated acceleration (filter at s.s.)','Estimated acceleration (predictor)', 'Estimated acceleration (predictor at s.s.)');
